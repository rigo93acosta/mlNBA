#!/usr/bin/env python3
"""
🎯 WRAPPER PARA ANÁLISIS DE ZONAS DE JUGADORES
==============================================

Script wrapper que ejecuta el analizador de zonas desde la raíz del proyecto,
...
# Importar y ejecutar
try:
    from player_zones_analyzer import main
    main()
